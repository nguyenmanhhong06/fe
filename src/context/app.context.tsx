...
export const AppProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const [message, setMessage] = useState<any | null>(initialAppContext.ticket)
  return (
    <AppContext.Provider
      value={{ isAuthenticated, setIsAuthenticated, profile, setProfile, ticket, setTicket, message, setMessage }}
    >
      {children}
    </AppContext.Provider>
  )
