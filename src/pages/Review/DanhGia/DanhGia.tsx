...
function DanhGia() {
  ...
  return (
    <>
      <HeaderSub />
      <div className='mx-auto px-4 pt-[140px] max-w-[1200px]'>
        ...
        <div className='grid grid-cols-3 items-stretch mt-4 gap-3'>
          <div className='col-span-1 shadow-t-mh rounded-lg'>
      ...
      <div className='mx-auto flex justify-end px-4 pt-[140px] max-w-[1200px]'>
